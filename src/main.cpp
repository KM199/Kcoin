...
uint256 hashGenesisBlock("0x809afa12fbeecfde659d2c356b43e270401a0475a063582bcaffa8be6a466433");
...
const string strMessageMagic = "Kcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Kcoin: 1 days
static const int64 nTargetSpacing = 120; // Kcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Kcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Kcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcf2e00a126a5ed144730a75158c98b13a2880eb2c68887a0704495ed85a7f351");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "FBI helped thwart nuclear smuggling plot in Moldova";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1444444444444; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 383019;

        if (fTestNet)
        {
            block.nTime    = 1444287600000;
            block.nNonce   = 162562;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x6000e2f2b132fb8597e4ad62ad459035b959e13d76c1c72679c93cb9e16c9ec3"));
